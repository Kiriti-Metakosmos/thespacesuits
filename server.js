...
app.get('/database', (req, res) => {
  const filtered = suits.slice().sort((a, b) => (a.sortYear - b.sortYear) || a.variantId.localeCompare(b.variantId));
...
app.get('/database/iva', (req, res) => {
  const ivaSuits = suits.filter(s => s.category === 'IVA')
    .sort((a, b) => (a.sortYear - b.sortYear) || a.variantId.localeCompare(b.variantId));
...
app.get('/programs/:nation', (req, res) => {
  ...
  const programSuits = suits.filter(s => s.nation === nation).sort((a, b) => (a.sortYear - b.sortYear) || a.variantId.localeCompare(b.variantId));
...
app.get('/prototypes', (req, res) => {
  const prototypeSuits = suits.filter(s => s.isPrototype === true).sort((a, b) => (a.sortYear - b.sortYear) || a.variantId.localeCompare(b.variantId));
